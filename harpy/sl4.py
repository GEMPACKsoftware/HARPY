...
class SL4(object):
    ...
    def __init__(self, fname, extractList=None):
        ...
        self.decode_SL4(fname, extractList)from __future__ import print_function, absolute_import
from .har_file import HarFileObj
from .header_array import HeaderArrayObj
import numpy as np
    ...
    def insertShocks(flatData, i, nshk, nexo, shockList, shockPtr, shockVal):
        if nshk > 0:
            ...
            if nshk == nexo:
                ...
                flatData[shockList.array[start:start+nshk,0]-1]=shockVal.array[start:start+nshk, 0]
